...
\end{align*}
    %     =&\frac{ \im g^3m^2}{\qty(p_1+p_2)^2}\qty[ \frac{-1}{z\langle34\rangle[k_13]}+\frac{-1}{\langle34\rangle(z[k_13]+[k_14])}+\frac{-1}{\langle34\rangle\qty([43]-[4k_1])}]\\
%     &\quad\quad\quad+\frac{ -\im g^3m^2}{\langle31\rangle[1k_1]}\qty[ \frac{-1}{\qty(\langle32\rangle-\langle42\rangle)\qty([23]-[2k_1])}+\frac{1}{\qty(p_2+l_3)^2}+\frac{1}{\qty(l_3+l_2)^2}]\\
...
\subsubsection{$l_1,l_2$ and $l_3$ massive}
