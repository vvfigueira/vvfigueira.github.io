...
Combining these two results we can rewrite the EH Action in the forms language, that is, the expression we're expecting to obtain is an integral over a $D$--form, in the middle of the computation 
