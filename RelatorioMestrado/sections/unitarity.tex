...
\begin{align*}
    ...
    \textnormal{Im}\qty[\mathcal A]&=-\frac12g^2\int\frac{\dd[4]{\ell}}{\qty(2\pi)^4}\qty(-\pi^2\delta\qty(\ell^2+m^2)\delta\qty(\qty(\ell-p)^2+m^2)+\textnormal{P.V.}\frac{1}{\ell^2+m^2}\textnormal{P.V.}\frac{1}{\qty(\ell-p)^2+m^2})
\end{align*}
...
\begin{align*}
    ...
    \textnormal{Im}\qty[\mathcal A^{\textnormal{1--loop}}_{1\rightarrow 1}]&=\frac18\qty(2\pi)^4\int\frac{\dd[3]{\vb q}\dd[3]{\boldsymbol\ell}}{\qty(2\pi)^62\omega_{\boldsymbol \ell}2\omega_{\vb q}}\delta^{\qty(4)}\qty(q+\ell- p)\abs{\mathcal A^{\textnormal{tree}}_{1\rightarrow 2}}^2, \ \ \ \mathcal A^{\textnormal{tree}}_{1\rightarrow 2}=g
\end{align*}
...
\begin{align*}
    \textnormal{Im}\qty[\mathcal A^{\textnormal{1--loop}}_{1\rightarrow 1}]&=\frac12
    \begin{tikzpicture}
...
sobre todas as maneiras de se separar as amplitudes. Este conceito de unitariedade é possível de ser estendido para o que 
