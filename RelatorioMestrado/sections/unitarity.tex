...
\begin{align*}
    ...
    -\im \mathfrak{Disc}\qty[\mathcal A^{\textnormal{Tree}}_{\gamma\alpha}]&=\sum\limits_\beta\pi\delta\qty(\qty(q^0)^2-\qty(p_\alpha^0)^2)\mathcal A^\ast_{\beta\gamma}\mathcal A_{\beta\alpha}\eval_{\vb q = \vb p_\alpha=\vb p_\gamma}\\
    -\im \mathfrak{Disc}\qty[\mathcal A^{\textnormal{Tree}}_{\gamma\alpha}]&=\sum\limits_\beta\pi\delta\qty(p_\alpha^2+m_\beta^2)\mathcal A^\ast_{\beta\gamma}\mathcal A_{\beta\alpha}\\
    \mathfrak{Disc}\qty[\mathcal A^{\textnormal{Tree}}_{\gamma\alpha}]&=\sum\limits_\beta\frac12\mathfrak{Disc}\qty[\qty(p_\alpha^2+m_\beta^2)^{-1}]\mathcal A^\ast_{\beta\gamma}\mathcal A_{\beta\alpha}\\
    \mathfrak{Disc}\qty[\mathcal A^{\textnormal{Tree}}_{\gamma\alpha}]&=\sum\limits_\beta\frac12\qty[\frac{1}{p_\alpha^2+m_\beta^2-\im\epsilon}-\frac{1}{p_\alpha^2+m_\beta^2+\im\epsilon}]\mathcal A^\ast_{\beta\gamma}\mathcal A_{\beta\alpha}
\end{align*}
