...
\begin{align*}
    ...
    \mathcal I^1_4\eval_{3\textnormal{ Cuts}}&=\frac12g^4\qty[\frac{1}{m^2+\qty(1+2)^2}+\frac{1}{m^2+\qty(1+\ell)^2}+\frac{1}{m^2+\qty(2+\ell)^2}]\times\\&\quad\quad\quad\times\qty[\frac{1}{m^2+\qty(3+4)^2}+\frac{1}{m^2+\qty(3-\ell)^2}+\frac{1}{m^2+\qty(4-\ell)^2}], 
\end{align*}
