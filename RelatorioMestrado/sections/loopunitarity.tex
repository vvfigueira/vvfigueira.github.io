...
\begin{tikzpicture}
  \begin{feynman}
    \vertex[blob, minimum size=14mm] (B) at (0,0) {};
    % compute radius: half the minimum size (7mm) plus an outward offset (2mm -> 0.2cm)
    % here we just pick 0.9cm for the example; adapt to your blob
    \placedots{B}{0.9cm}{ {180,190,170} } % three dots on the upper hemisphere
  \end{feynman}
\end{tikzpicture}