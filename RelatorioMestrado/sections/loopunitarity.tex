...
\[\qty(p_\alpha^2+m_\beta^2)\mathcal A_{\gamma\alpha}=\tilde{\mathcal A}^\ast_{\beta\gamma}\tilde{\mathcal A}_{\beta\alpha}\eval_{p_\alpha^2=-m_\beta^2},\]
...
\begin{align*}
    ...
    \end{tikzpicture}}]&=\sum\raisebox{+3pt}{\begin{tikzpicture}[baseline=(b.base)]
        \begin{feynman}
            ...
            \vertex (D2) at (3,0) {$\cdots$};
            \vertex (F1) at (2.8,0.6);
            \vertex (F2) at (2.8,-0.6);

            % \vertex (II1) at (3.2,0.6);
            % \vertex (II2) at (3.2,-0.6);
            % \vertex (DD2) at (4,0) {$\cdots$};
            % \vertex [blob, minimum size=1cm] (BB) at (5,0) {};
            % \vertex (dd1) at (6,0) {$\raisebox{6pt}{\vdots}$};
            % \vertex (dd2) at (8,0) {$\raisebox{6pt}{\vdots}$};
            % \vertex [blob, minimum size=1cm] (bb) at (7,0) {};
            % \vertex (ii1) at (8,1);
            % \vertex (ii2) at (8,-1);
            ...
            \diagram*{
                (i1) -- [fermion] (b) [blob],
                (i2) -- [fermion] (b),
                (b) -- [fermion, bend left=45, looseness=1] (B),
                (b) -- [fermion, bend right=45, looseness=1] (B),
