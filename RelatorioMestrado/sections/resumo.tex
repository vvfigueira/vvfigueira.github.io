...
teoria $\qty(DF)^2$ e, utilizando-se do método da cópia dupla, estender esses resultados para o caso da 
super-gravidade conforme do tipo Berkovits-Witten. Estes estudos também preveem uma maior compreensão
