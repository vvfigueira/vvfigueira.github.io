...
\begin{titlepage}
    \begin{center}
        ...
        \Large \textbf{\textsc{Testando o Modelo Padrão em sinais de Transições de Fase Cosmológicas}}
 	    \HRule{1.5pt} \\ [0.5cm]
        \linespread{1}
        \large Relatório científico anual do projeto na modalidade Iniciação Científica --- Fluxo Contínuo, fomentado pela FAPESP. \\ 
   	    \HRule{1.5pt} \\ [0.5cm]       
        Projeto FAPESP~\texttt{\#2024/06488-0}
        \\ [0.5cm]
        Pesquisador Responsável: Gabriel \\
